...
export const simulation_add_particles_with_temp: (a: number, b: number, c: number, d: number, e: number) => number;
...
export const simulation_set_heat_source: (a: number, b: number) => void;
