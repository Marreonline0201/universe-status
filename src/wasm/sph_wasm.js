...
export class Simulation {
     ...
     */
    get_materials() {
        const ret = wasm.simulation_get_materials(this.__wbg_ptr);
     ...
     */
    get_velocities() {
        const ret = wasm.simulation_get_velocities(this.__wbg_ptr);
        var v1 = getArrayF32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
    ...
    step(gravity, dt, sub_steps) {
        wasm.simulation_step(this.__wbg_ptr, gravity, dt, sub_steps);
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('sph_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
